...
class Plasma(CMakePackage):
    ...
    url      = "https://github.com/icl-utk-edu/plasma/releases/download/22.9.29/plasma-22.9.29.tar.gz"
    ...
    version('17.1', sha256="d4b89f7c3d240a69dfe986284a14471eec4830b9e352ae902ea8861f15573dee", url='https://github.com/icl-utk-edu/plasma/releases/download/17.01/plasma-17.01.tar.gz')
