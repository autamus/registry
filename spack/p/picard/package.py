...
class Picard(Package):
    ...
    url      = "https://github.com/broadinstitute/picard/releases/download/2.26.10/picard.jar"
    ...
    version('2.26.10', sha256='84a056466cf23155e2126b33fde61b5485217b365d4899c1bdc82fe9284f2395')
