...
class Picard(Package):
    ...
    url      = "https://github.com/broadinstitute/picard/releases/download/2.27.3/picard.jar"
    ...
    version('2.27.3', sha256='4b375ca3d1a82fbe0206fc9b363e7082a4fa14aff689f5e0e3311de5006a16c8')
