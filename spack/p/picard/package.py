...
class Picard(Package):
    ...
    url      = "https://github.com/broadinstitute/picard/archive/2.26.6.tar.gz"
    ...
    version('2.26.6', sha256='5a8cb2fd1b369d3406a25006ce317d45dd1532b4d89741e2c12ebffeeb287cdd')
