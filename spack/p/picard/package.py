...
class Picard(Package):
    ...
    url      = "https://github.com/broadinstitute/picard/releases/download/2.26.7/picard.jar"
    ...
    version('2.26.7', sha256='92097395e91d226387110fb79ba29cf7b25286fdb1ce1277ba0912963d0d3a05')
