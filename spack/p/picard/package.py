...
class Picard(Package):
    ...
    url      = "https://github.com/broadinstitute/picard/releases/download/2.26.8/picard.jar"
    ...
    version('2.26.8', sha256='bd3030059fa5906c648c148c85282e8397886fa7c71996b21918b3837453645e')
