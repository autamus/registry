...
class Protobuf(Package):
    ...
    url      = "https://github.com/protocolbuffers/protobuf/archive/v21.6.tar.gz"

    version('21.6', sha256='dbb16fdbca8f277c9a194d9a837395cde408ca136738d94743130dd0de015efd')
