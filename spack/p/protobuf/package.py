...
class Protobuf(Package):
    ...
    url      = "https://github.com/protocolbuffers/protobuf/archive/v21.4.tar.gz"

    version('21.4', sha256='990e47a163b4057f98b899eca591981b5b735872b58f59b9ead9cecabbb21a2a')
