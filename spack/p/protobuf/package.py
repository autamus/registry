...
class Protobuf(Package):
    ...
    url      = "https://github.com/protocolbuffers/protobuf/archive/v21.8.tar.gz"

    version('21.8', sha256='032ef6fbb5b2ce2147e913b053003c7881fe53861571079b4351c006d6a822c1')
