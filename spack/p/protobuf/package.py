...
class Protobuf(Package):
    ...
    url      = "https://github.com/protocolbuffers/protobuf/archive/v21.3.tar.gz"

    version('21.3', sha256='1e958b62debbb46ebefa16d848741d17c88dc018dd57b729c0cd58965380f3f8')
