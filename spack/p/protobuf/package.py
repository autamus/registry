...
class Protobuf(Package):
    ...
    url      = "https://github.com/protocolbuffers/protobuf/archive/v21.5.tar.gz"

    version('21.5', sha256='4a7e87e4166c358c63342dddcde6312faee06ea9d5bb4e2fa87d3478076f6639')
