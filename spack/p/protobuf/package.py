...
class Protobuf(Package):
    ...
    url      = "https://github.com/protocolbuffers/protobuf/archive/v21.0.tar.gz"

    version('21.0', sha256='26606cdd38c35d43ba42df92900672f7e5e2d3fb16fb9c46a99db3a767556d3e')
