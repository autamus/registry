...
class Spades(CMakePackage):
    ...
    url      = "https://github.com/ablab/spades/archive/v3.15.2.tar.gz"

    version('3.15.2', sha256='fba9355276999a12a5cedb0585d536e48ddc8124dae2ffc6666cd42e6a328f60', url='https://github.com/ablab/spades/archive/v3.15.2.tar.gz')
