...
class Samtools(Package):
    ...
    version('1.11', sha256='e283cebd6c1c49f0cf8a3ca4fa56e1d651496b4d2e42f80ab75991a9ece4e5b6', url='https://github.com/samtools/samtools/releases/download/1.11/samtools-1.11.tar.bz2')
