...
class Sz(CMakePackage):
    ...
    url      = "https://github.com/szcompressor/SZ/releases/download/2.1.11.2/SZ-2.1.11.2.tar.gz"
    ...
    version('2.1.11.2', sha256='e4f8ad8f4cb232b7bc20cd2924a2a338495119123c21018b91af9e1ffe3fb94d', url='https://github.com/szcompressor/SZ/releases/download/2.1.11.2/SZ-2.1.11.2.tar.gz')
