...
class Julia(Package):
    ...
    url      = "https://github.com/JuliaLang/julia/releases/download/v1.7.3/julia-1.7.3-full.tar.gz"
    git      = "https://github.com/JuliaLang/julia.git"

    maintainers = ['glennpj', 'vchuravy']

    version('master', branch='master')
    version('1.7.3', sha256='4be529b0716de1ec48ba52e83a0fafd4be2269be9cc43074ad15ce788aeca093')
