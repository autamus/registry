...
class Julia(Package):
    ...
    version('1.6.2', sha256='ca62270db9f4e5e4af60f2e2495e430833f1293ca6f0ec66022bc6beb0c1e133', url='https://github.com/JuliaLang/julia/releases/download/v1.6.2/julia-1.6.2-full.tar.gz')
