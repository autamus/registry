...
class Jasper(Package):
    ...
    url      = "https://github.com/mdadams/jasper/archive/manual-version-mdadams-20220115-1144.tar.gz"

    version('20220115.1144', sha256='a97c447a1d9109279cc43955cbc8380f26d1b50b714cfc2bf485201bb864bee6')
