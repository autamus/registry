...
class Ascent(CMakePackage, CudaPackage):
    ...
    url      = "https://github.com/Alpine-DAV/ascent/releases/download/v0.9.0/ascent-v0.9.0-src-with-blt.tar.gz"
    tags = ["radiuss", "e4s"]

    maintainers = ["cyrush"]

    version('develop', branch='develop', submodules=True)
    version('0.9.0', sha256='dc93dcc9ea44cea9fb2049babc157aadb56d231473e106232c35ee9c78fe3f1c')
    version('0.8.0', submodules=True, tag='v0.8.0')
