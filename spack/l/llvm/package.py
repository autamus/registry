...
class Llvm(CMakePackage, CudaPackage):
    ...
    url      = "https://github.com/llvm/llvm-project/archive/llvmorg-17-init.tar.gz"
    ...
    version('17', sha256='59c1cfccfe5a0f722d0a1254705716f294d6cc21b2c4a1a67271ddbb9f8e07d0')
