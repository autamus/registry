...
class Lmod(AutotoolsPackage):
    ...
    url      = "https://github.com/TACC/Lmod/archive/8.5.tar.gz"

    version('8.5', sha256='ccb3066c4edb43ec7aab45a4f939b95012ae80c464d865870e9a497e6d9fd797', url='https://github.com/TACC/Lmod/archive/8.5.tar.gz')
