...
class Graphviz(AutotoolsPackage):
    ...
    url      = "https://gitlab.com/graphviz/graphviz/-/archive/7.0.4/graphviz-7.0.4.tar.bz2"

    version('7.0.4', sha256='b5b85e8adbc16083cc3151d5f41eb65ae0744632040a21fd3854d0bf98492c8c')
