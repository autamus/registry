...
class Graphviz(AutotoolsPackage):
    ...
    url      = "https://gitlab.com/graphviz/graphviz/-/archive/7.0.5/graphviz-7.0.5.tar.bz2"

    version('7.0.5', sha256='442fd86d5aa30f172ef0f4ac265a8f8ee6754c0d4f09a9a8ff04b41e89e6f2e3')
