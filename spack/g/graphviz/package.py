...
class Graphviz(AutotoolsPackage):
    ...
    url      = "https://gitlab.com/graphviz/graphviz/-/archive/7.0.3/graphviz-7.0.3.tar.bz2"

    version('7.0.3', sha256='a424fb1ada42605a3217c4571aa27a40af70a91b4a759ef8f98073690f673c51')
