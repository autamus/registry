...
class Go(Package):
    ...
    extendable = True
    executables = ['^go$']
    version('1.17', sha256='3a70e5055509f347c0fb831ca07a2bf3b531068f349b14a3c652e9b5b67beb5d', url='https://dl.google.com/go/go1.17.src.tar.gz')
    version('1.16.7', sha256='1a9f2894d3d878729f7045072f30becebe243524cf2fce4e0a7b248b1e0654ac', url='https://dl.google.com/go/go1.16.7.src.tar.gz')
    version('1.16.6', sha256='a3a5d4bc401b51db065e4f93b523347a4d343ae0c0b08a65c3423b05a138037d', url='https://dl.google.com/go/go1.16.6.src.tar.gz')
    ...
    version('1.9.0', sha256='a4ab229028ed167ba1986825751463605264e44868362ca8e7accc8be057e993')
    ...
    version('1.8.0', sha256='406865f587b44be7092f206d73fc1de252600b79b3cacc587b74b5ef5c623596')
