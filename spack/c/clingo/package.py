...
class Clingo(CMakePackage):
    ...
    version('main', branch='master', submodules=True)
    version('spack', submodules=True)
    version('5.5.0', sha256='c9d7004a0caec61b636ad1c1960fbf339ef8fdee9719321fc1b6b210613a8499', url='https://github.com/potassco/clingo/archive/v5.5.0.tar.gz')
    version('5.4.1', sha256='ac6606388abfe2482167ce8fd4eb0737ef6abeeb35a9d3ac3016c6f715bfee02', url='https://github.com/potassco/clingo/archive/v5.4.1.tar.gz')
