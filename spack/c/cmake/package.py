...
class Cmake(Package):
    ...
    executables = ['^cmake$']
    version('3.21.1', sha256='fac3915171d4dff25913975d712f76e69aef44bf738ba7b976793a458b4cfed4', url='https://github.com/Kitware/CMake/releases/download/v3.21.1/cmake-3.21.1.tar.gz')
    version('3.21.0', sha256='4a42d56449a51f4d3809ab4d3b61fd4a96a469e56266e896ce1009b5768bd2ab', url='https://github.com/Kitware/CMake/releases/download/v3.21.0/cmake-3.21.0.tar.gz')
    version('3.20.5', sha256='12c8040ef5c6f1bc5b8868cede16bb7926c18980f59779e299ab52cbc6f15bb0', url='https://github.com/Kitware/CMake/releases/download/v3.20.5/cmake-3.20.5.tar.gz')
