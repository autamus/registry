...
class Bedops(MakefilePackage):
    ...
    version('2.4.40', sha256='0670f9ce2da4b68ab13f82c023c84509c7fce5aeb5df980c385fac76eabed4fb', url='https://github.com/bedops/bedops/archive/v2.4.40.tar.gz')
    version('2.4.39', sha256='f8bae10c6e1ccfb873be13446c67fc3a54658515fb5071663883f788fc0e4912', url='https://github.com/bedops/bedops/archive/v2.4.39.tar.gz')
