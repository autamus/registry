...
class Bracken(Package):
    ...
    url      = "https://github.com/jenniferlu717/Bracken/archive/v2.6.2.tar.gz"

    version('2.6.2', sha256='c83665c613861fe0dc2637d9c190105f0b08f5c4cda97a0dc86a6357aab66be3', url='https://github.com/jenniferlu717/Bracken/archive/v2.6.2.tar.gz')
