...
class Openbabel(CMakePackage):
    ...
    version('3.1.1', sha256='5c630c4145abae9bb4ab6c56a940985acb6dadf3a8c3a8073d750512c0220f30', url='https://github.com/openbabel/openbabel/archive/openbabel-3-0-0.tar.gz')
    version('3.0.0')
    version('2.4.1')
    version('2.4.0')
