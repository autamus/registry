...
class Mysql(CMakePackage):
    ...
    git      = "https://github.com/mysql/mysql-server"

    version('8.0.23', sha256='d26cbbf9eccf8c8f14743c3e26c37a8ba71ebd45e8b2d66c6dd37790037bb787', url='https://dev.mysql.com/get/Downloads/MySQL-8.0/mysql-8.0.23.tar.gz')
    ...
    # 8.0.23+
    depends_on('boost@1.73.0 cxxstd=98', type='build', when='@8.0.23: cxxstd=98')
    depends_on('boost@1.73.0 cxxstd=11', type='build', when='@8.0.23: cxxstd=11')
    depends_on('boost@1.73.0 cxxstd=14', type='build', when='@8.0.23: cxxstd=14')
    depends_on('boost@1.73.0 cxxstd=17', type='build', when='@8.0.23: cxxstd=17')
    # 8.0.19--8.0.22
