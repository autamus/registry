...
class Rclone(Package):
    ...
    url      = "https://github.com/ncw/rclone/releases/download/v1.59.0/rclone-v1.59.0.tar.gz"

    maintainers = ['alecbcs']

    version('1.59.0', sha256='9061caad3082f4d275d90f2975ef120fb71f6537ed88d08db1a3b5404db5ae49')
