...
class Rclone(Package):
    ...
    url      = "https://github.com/ncw/rclone/releases/download/v1.60.1/rclone-v1.60.1.tar.gz"

    maintainers = ["alecbcs"]

    version('1.60.1', sha256='51b8d39b8fd419868d91ed5d0d0a22fb80d943f3fd3bab645c5498a3ad8b3dd9')
