...
class Rclone(Package):
    ...
    url      = "https://github.com/ncw/rclone/releases/download/v1.61.0/rclone-v1.61.0.tar.gz"

    maintainers = ["alecbcs"]

    version('1.61.0', sha256='dedc5cd6e34d8636eab14c6ea858d1b83de7b546b69eb5538ea6a2ec69a8b5d5')
